  ...
  export default {
    ...
    data() {
      return {
        // 课程配置
        courses: [
          { name: '密码学', color: '#409EFF' },
          { name: 'web安全', color: '#67C23A' },
          { name: '', color: '#E6A23C' },
          { name: '物理', color: '#F56C6C' }
        ],
        ...
        // 原始数据（模拟10天数据）
        rawData: {
          '数学': [45, 52, 38, 65, 72, 48, 60, 55, 70, 62],
          '语文': [38, 49, 55, 42, 58, 50, 62, 45, 53, 60],
          '英语': [60, 55, 48, 52, 44, 58, 50, 62, 57, 49],
          '物理': [28, 35, 40, 32, 45, 38, 42, 36, 44, 39]
        }
      }
    },
